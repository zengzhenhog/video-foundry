...
from video_foundry.shared.schemas import DEFAULT_FORMATS, Project, utc_now
...
class ProjectStorage:
    ...
    def write_bytes(self, project_id: str, relative_path: str, data: bytes) -> Path:
        target_path = self.resolve_project_path(project_id, relative_path)
        target_path.parent.mkdir(parents=True, exist_ok=True)
    ...
    def project_path(self, project_id: str) -> Path:
        return self._project_dir_or_error(project_id)

    def resolve_project_path(self, project_id: str, relative_path: str) -> Path:
        return self._relative_path_or_error(project_id, relative_path)

    def project_file_exists(self, project_id: str, relative_path: str) -> bool:
        return self.resolve_project_path(project_id, relative_path).exists()
