...
def get_settings() -> AppSettings:
    root_dir = Path(os.environ.get("AUTO_IMAGE_ROOT_DIR", Path(__file__).resolve().parents[3]))
    projects_dir = os.environ.get("AUTO_IMAGE_PROJECTS_DIR")
    config_dir = os.environ.get("AUTO_IMAGE_CONFIG_DIR")
