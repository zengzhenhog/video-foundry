...
- `src/video_foundry/renderer/**`
- `src/video_foundry/ffmpeg/**`
- `src/video_foundry/audio/mixer.py`
- `src/video_foundry/api/routes/**`
- `src/video_foundry/api/main.py` 或 Phase 1 建立的集中 router 聚合文件
- `src/video_foundry/shared/**` 中与 render preset 和输出路径相关的内容
...
- `src/video_foundry/renderer/__init__.py`
- `src/video_foundry/renderer/crops.py`
- `src/video_foundry/renderer/frame_renderer.py`
- `src/video_foundry/renderer/subtitle_overlay.py`
- `src/video_foundry/renderer/manifest.py`
- `src/video_foundry/ffmpeg/__init__.py`
- `src/video_foundry/ffmpeg/command_builder.py`
- `src/video_foundry/ffmpeg/assembler.py`
- `src/video_foundry/audio/mixer.py`
- `src/video_foundry/api/routes/render.py`
