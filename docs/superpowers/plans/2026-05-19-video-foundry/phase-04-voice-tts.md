...
- `src/video_foundry/voice/__init__.py`
- `src/video_foundry/voice/base.py`
- `src/video_foundry/voice/mock_provider.py`
- `src/video_foundry/voice/provider_registry.py`
- `src/video_foundry/api/routes/voice.py`
