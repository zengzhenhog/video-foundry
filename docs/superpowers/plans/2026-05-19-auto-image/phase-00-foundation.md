...
- `pyproject.toml`
- `src/auto_image/__init__.py`
- `src/auto_image/api/__init__.py`
- `src/auto_image/api/main.py`
- `src/auto_image/api/routes/__init__.py`
- `src/auto_image/shared/__init__.py`
- `src/auto_image/shared/config.py`
...
3. 创建 `src/auto_image` 包结构。Phase 0 只需要真实导入路径和必要的 `__init__.py`。
