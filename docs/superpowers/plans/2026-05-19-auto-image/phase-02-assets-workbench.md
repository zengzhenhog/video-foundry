...
- `src/auto_image/audio/background_music.py`
- `src/auto_image/shared/**` 中与 Asset、BackgroundMusic、存储辅助相关的内容
...
- `src/auto_image/sources/__init__.py`
- `src/auto_image/sources/upload_importer.py`
- `src/auto_image/audio/__init__.py`
- `src/auto_image/audio/background_music.py`
- `src/auto_image/api/routes/assets.py`
