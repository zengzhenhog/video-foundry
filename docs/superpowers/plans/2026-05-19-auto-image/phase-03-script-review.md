...
- `src/auto_image/ai/__init__.py`
- `src/auto_image/ai/base.py`
- `src/auto_image/ai/mock_provider.py`
- `src/auto_image/ai/script_generator.py`
- `src/auto_image/api/routes/script.py`
