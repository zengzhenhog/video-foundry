...
- `src/auto_image/sources/**`
- `src/auto_image/jobs/**`
- `src/auto_image/ai/**`
- `src/auto_image/voice/**`
- `src/auto_image/shared/**`
...
- `src/auto_image/sources/nasa_api.py`
- `src/auto_image/jobs/queue.py`
- `src/auto_image/jobs/concurrency.py`
- `src/auto_image/shared/index_store.py`
- `src/auto_image/shared/cache.py`
- `src/auto_image/api/routes/imports.py`
- `src/auto_image/api/routes/batch.py`
