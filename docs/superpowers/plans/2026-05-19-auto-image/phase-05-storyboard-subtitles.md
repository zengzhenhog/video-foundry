...
- `src/auto_image/storyboard/**`
- `src/auto_image/subtitles/**`
...
- `src/auto_image/storyboard/__init__.py`
- `src/auto_image/storyboard/planner.py`
- `src/auto_image/storyboard/validator.py`
- `src/auto_image/subtitles/__init__.py`
- `src/auto_image/subtitles/generator.py`
- `src/auto_image/api/routes/storyboard.py`
- `src/auto_image/api/routes/subtitles.py`
