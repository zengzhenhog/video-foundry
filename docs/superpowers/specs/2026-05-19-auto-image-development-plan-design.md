...
auto-image/
  docs/
    ...
    superpowers/
      specs/
        2026-05-19-auto-image-development-plan-design.md
  src/
    auto_image/
      __init__.py
      api/
...
所有后端模型必须定义在 `src/auto_image/shared/schemas.py`，并通过 Pydantic 校验。
...
```text
请执行 Auto Image 开发计划的 Phase X。

上下文：
- 阅读 docs/system-design.md
- 阅读 docs/superpowers/specs/2026-05-19-auto-image-development-plan-design.md
